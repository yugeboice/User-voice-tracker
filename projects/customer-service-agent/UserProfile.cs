...
public record UserProfile(
    ...
    [property: JsonPropertyName("monitoring_config")] MonitoringConfig? MonitoringConfig
);
...
public record MonitoringConfig(
    [property: JsonPropertyName("primary_brands")] string[]? PrimaryBrands,
    [property: JsonPropertyName("competitor_brands")] string[]? CompetitorBrands,
    [property: JsonPropertyName("alert_keywords")] string[]? AlertKeywords
);
