...
1. Focus the cursor on the address bar, which can be achieved with Ctrl+L
2. Type `va.gov` and press enter
3. Wait for the page loaded

According to the [API reference](../../reference/agent-api-ref.md), these actions can be translated to below request:
...
![navigate-to-website](./images/navigate-to-website.png)
...
![test-search](./images/test-search.png)
...
![click-search-result](./images/click-search-result.png)
